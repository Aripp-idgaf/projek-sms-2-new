...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .log-left { flex: 1; position: relative; overflow: hidden; padding: 40px; display: flex; flex-direction: column; justify-content: space-between; }
        ...
        .slider-overlay { position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: linear-gradient(135deg, rgba(40, 45, 50, 0.6) 0%, rgba(20, 25, 30, 0.5) 100%); z-index: 1; }
        ...
        /* WARNA FOCUS KE HITAM MURNI & KUSTOMISASI DROPDOWN */
        ...
        .input-icon i.bi { position: absolute; left: 18px; top: 50%; transform: translateY(-50%); color: #a0b8c2; font-size: 1.1rem; z-index: 5; transition: color 0.2s; }
        
        .input-icon i.toggle-password { left: auto; right: 18px; cursor: pointer; }
        ...
        .custom-dropdown-menu {
            ...
            border: 1px solid rgba(56, 200, 230, 0.1) !important;
            margin-top: 8px !important;
        }
        .custom-dd-item {
            border-radius: 10px; padding: 10px 16px; font-size: 0.85rem; color: #2c3e50;
            font-weight: 500; transition: all 0.2s ease; margin-bottom: 2px;
        }
        .custom-dd-item:hover { background-color: #f4f8f8; color: #117a8b; transform: translateX(4px); }
        .custom-dd-item.active { background-color: rgba(56, 200, 230, 0.1); color: #117a8b; font-weight: 700; }
        ...
        /* Alert style yang sudah diperbaiki agar tidak memecah flexbox */
        .notif-container {
            width: 100%;
            display: flex;
        ...
        .alert-error {
            background-color: #f8d7da; color: #721c24; padding: 8px 15px; border-radius: 8px;
            font-size: 0.8rem; text-align: center; margin-bottom: 20px; border: 1px solid #f5c6cb;
            width: 100%; font-weight: 500;
        }
        .alert-success {
            background-color: #d4edda; color: #155724; padding: 8px 15px; border-radius: 8px;
            font-size: 0.8rem; text-align: center; margin-bottom: 20px; border: 1px solid #c3e6cb;
            width: 100%; font-weight: 500;
        }
    </style>
</head>
<body class="login-mode">
    ...
    <div class="login-wrapper">
        <div class="login-split">
            <div class="log-left">
                <div class="slider-container"><div class="slider-track" id="slider-track"></div></div>
            ...
            <div class="log-right" id="form-container">
                ...
                <form action="registrasi_proses.php" method="POST" id="register-form" class="d-none" style="display: flex; flex-direction: column; height: 100%;">
                    ...
                    <div class="input-icon">
                        ...
                        <input type="number" name="umur" id="regUmur" class="cal-input" placeholder="Umur (Tahun)" required>
                    </div>
